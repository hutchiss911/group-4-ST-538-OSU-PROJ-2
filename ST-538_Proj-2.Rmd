...
train_conf_matrix_2
#the model did not predict any instances as belonging to class 1 when threashold is 0.6
```
...
#Fit model
xgb.loan2 <- xgboost(
  data = train2.matrix, label = train.labels,
...
Both the training and validation accuracies are around 78%, suggesting the model maintains consistent overall prediction accuracy on both seen and unseen data. However, their precision and recall metrics do not match those of the initial XGBoost training model. This training iteration does not exhibit any improvement compared to the initial model.
